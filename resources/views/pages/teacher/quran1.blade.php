...
<title>معلمة مقرأة متين — برنامج متين العلمي</title>
...
<link href="/Mateen/css/teacher.css" rel="stylesheet"/>
...
<div class="teacher-name" id="teacherName">أستاذة رُميساء محمد السيد الزهري</div>
<div class="teacher-subj">مقرأة متين</div>
...
<i class="ti ti-chevron-left" style="font-size:12px"></i>
<span id="breadcrumbName">أستاذة رُميساء محمد السيد الزهري</span>
</div>
...
<img alt="متين" src="/Mateen/logo.png" style="width:32px;height:32px;border-radius:50%;object-fit:cover;border:1px solid var(--gold);"/>
...
<script src="/Mateen/js/teacher-quran1-1.js?v=20260723" type="module"></script>
