...
<title>معلمة الفقه — برنامج متين العلمي</title>
...
<div class="teacher-name" id="teacherName">دكتورة أماني عقلان</div>
<div class="teacher-subj">الفقه</div>
...
<i class="ti ti-chevron-left" style="font-size:12px"></i>
<span id="breadcrumbName">دكتورة أماني عقلان</span>
</div>
...
<script src="/Mateen/js/teacher-fiqh-1.js?v=20260723" type="module"></script>
