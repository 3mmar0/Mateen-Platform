...
class LibraryController extends Controller {
 public function index(Request $r){$this->authorize('viewAny',LibraryItem::class);return ['data'=>LibraryItem::when($r->string('section')->toString(),fn($q,$v)=>$q->where('section',$v))->orderBy('sort_order')->get()];}
