...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('subjects/{subject}/materials', [MaterialController::class, 'index']); Route::post('subjects/{subject}/materials', [MaterialController::class, 'store']);
        ...
        Route::apiResource('library', LibraryController::class)->parameters(['library'=>'library'])->only(['index','store','update','destroy']);
        Route::apiResource('news', NewsController::class)->only(['index','store','update','destroy']);
